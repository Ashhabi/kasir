    ...
    ***********************************-->
    <div id="main-wrapper">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <form action="/logout" method="post">
                                            @csrf
                                            <button type="submit" class="dropdown-item"><i class="icon-key"></i>
                                            <span>Logout</button>
                                        </form>
                                        @else
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="bi bi-layout-text-window-reverse"></i></i><span class="nav-text">Dashboard</span>
                        </a>
                    </li>
                    <li class="nav-label">UI Components</li>
                    <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-discount menu-icon"></i><span class="nav-text">Setting Diskon</span>
                        </a>
                    </li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Designed & Developed by <a href="#">Ashhabi</a> 2023</p>
            </div>
        </div>
        <!--**********************************
            Footer end
